...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .sec-label { font-size: 11px; text-transform: uppercase; letter-spacing: 0.12em; color: var(--accent); font-weight: 500; margin-bottom: 0.85rem; }
  main h2 { font-family: var(--serif); font-size: clamp(24px, 3.2vw, 32px); line-height: 1.2; letter-spacing: -0.015em; margin-bottom: 1.25rem; }
  main h3 { font-family: var(--serif); font-size: 21px; line-height: 1.3; margin: 0 0 0.75rem; }
...
<main>
  ...
  <section>
    ...
    <ul class="tiers">
      ...
      <li><span class="lvl">Upper end</span><span>Peeling, gouges, or actual repair before any finish goes on.</span></li>
    </ul>
  </section>

  <!-- PAYMENT -->
  <section>
    <div class="sec-label">Deposit &amp; payment</div>
    <h2>Simple payment schedule</h2>
    <p>A deposit reserves your spot on the calendar. For most jobs it&rsquo;s:</p>
    <ul class="tiers">
      <li><span class="lvl">30% deposit</span><span>Due to schedule the work. Covers materials and secures your date.</span></li>
      <li><span class="lvl">70% balance</span><span>Due once the job is complete and you&rsquo;re satisfied.</span></li>
    </ul>
    <p>Exact terms are confirmed with your written estimate.</p>
  </section>
